...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/04/24 20:45:27 by htouil            #+#    #+#             */
/*   Updated: 2023/04/24 20:45:28 by htouil           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../../so_long.h"

void	cdts_for_down1(t_axe *axe, int i, int j)
{
...
void	cdts_for_down2(t_axe *axe, int i, int j)
{
...
void	merge_cdts_down(t_axe *axe, int i, int j)
{
